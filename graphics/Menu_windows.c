...
Button** crate_enterance_buttons(SDL_Renderer* renderer){
	...
	int gap_window = 100;
	int i = 0;
	SDL_Rect new_game = {.x = 75, .y = DEFAULT_GAP_WINDOW + DEFAULT_BTN_GAP*(i++), .h = DEFAULT_BTN_HIGHT, .w = DEFAULT_BTN_WIDTH};
	SDL_Rect load = {.x = 75, .y = DEFAULT_GAP_WINDOW + DEFAULT_BTN_GAP*(i++), .h = DEFAULT_BTN_HIGHT, .w = DEFAULT_BTN_WIDTH};
	SDL_Rect exit = {.x = 75, .y = DEFAULT_GAP_WINDOW + DEFAULT_BTN_GAP*(i++), .h = DEFAULT_BTN_HIGHT, .w = DEFAULT_BTN_WIDTH};
